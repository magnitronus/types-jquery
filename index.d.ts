...
interface BaseJQueryEventListener<T extends BaseJQueryEventObject> {
    (this: HTMLElement, eventObject: T, ...eventData: any[]): any;
}

interface JQueryEventListener extends BaseJQueryEventListener<JQueryEventObject> {

}

interface JQueryKeyEventListener extends BaseJQueryEventListener<JQueryKeyEventObject> {
...
interface JQuery {
     ...
     * @param complete A function to call once the animation is complete.
     */
    fadeIn(duration?: number|string, complete?: (this: HTMLElement) => any): JQuery;
    /**
     * Display the matched elements by fading them to opaque.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     * @param complete A function to call once the animation is complete.
     */
    fadeIn(duration?: number|string, easing?: string, complete?: (this: HTMLElement) => any): JQuery;
    /**
     * Display the matched elements by fading them to opaque.
     *
     * @param options A map of additional options to pass to the method.
     ...
     * @param complete A function to call once the animation is complete.
     */
    fadeOut(duration?: number|string, complete?: (this: HTMLElement) => any): JQuery;
    /**
     * Hide the matched elements by fading them to transparent.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     * @param complete A function to call once the animation is complete.
     */
    fadeOut(duration?: number|string, easing?: string, complete?: (this: HTMLElement) => any): JQuery;
    /**
     * Hide the matched elements by fading them to transparent.
     *
     * @param options A map of additional options to pass to the method.
     ...
     * @param complete A function to call once the animation is complete.
     */
    fadeTo(duration: string|number, opacity: number, complete?: (this: HTMLElement) => any): JQuery;
    /**
     * Adjust the opacity of the matched elements.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     * @param complete A function to call once the animation is complete.
     */
    fadeTo(duration: string|number, opacity: number, easing?: string, complete?: (this: HTMLElement) => any): JQuery;
     ...
     * @param complete A function to call once the animation is complete.
     */
    fadeToggle(duration?: number|string, complete?: (this: HTMLElement) => any): JQuery;
    /**
     * Display or hide the matched elements by animating their opacity.
     *
     * @param duration A string or number determining how long the animation will run.
     ...
     * @param complete A function to call once the animation is complete.
     */
    fadeToggle(duration?: number|string, easing?: string, complete?: (this: HTMLElement) => any): JQuery;
    /**
     * Display or hide the matched elements by animating their opacity.
     *
     * @param options A map of additional options to pass to the method.
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    blur(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "blur" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    blur(eventData?: any, handler?: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    change(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "change" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    change(eventData?: any, handler?: JQueryEventListener): JQuery;
     ...
     * @param eventData An object containing data that will be passed to the event handler.
     */
    click(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "click" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    click(eventData?: any, handler?: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    dblclick(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "dblclick" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    dblclick(eventData?: any, handler?: JQueryEventListener): JQuery;

    delegate(selector: any, eventType: string, handler: JQueryEventListener): JQuery;
    delegate(selector: any, eventType: string, eventData: any, handler: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    focus(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "focus" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    focus(eventData?: any, handler?: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    focusin(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "focusin" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    focusin(eventData: Object, handler: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    focusout(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "focusout" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    focusout(eventData: Object, handler: JQueryEventListener): JQuery;
     ...
     */
    hover(handlerIn: JQueryEventListener, handlerOut: JQueryEventListener): JQuery;
    /**
     * Bind a single handler to the matched elements, to be executed when the mouse pointer enters or leaves the elements.
     *
     * @param handlerInOut A function to execute when the mouse pointer enters or leaves the element.
     */
    hover(handlerInOut: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    keydown(handler: JQueryKeyEventListener): JQuery;
    /**
     * Bind an event handler to the "keydown" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    keydown(eventData?: any, handler?: JQueryKeyEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    keypress(handler: JQueryKeyEventListener): JQuery;
    /**
     * Bind an event handler to the "keypress" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    keypress(eventData?: any, handler?: JQueryKeyEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    keyup(handler: JQueryKeyEventListener): JQuery;
    /**
     * Bind an event handler to the "keyup" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    keyup(eventData?: any, handler?: JQueryKeyEventListener): JQuery;
     ...
     * @param handler A function to execute when the event is triggered.
     */
    load(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "load" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute when the event is triggered.
     */
    load(eventData?: any, handler?: JQueryEventListener): JQuery;
     ...
     */
    off(events: string, selector?: string, handler?: JQueryEventListener): JQuery;
    /**
     * Remove an event handler.
     *
     * @param events One or more space-separated event types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".
     ...
     */
    off(events: string, handler: JQueryEventListener): JQuery;
    /**
     * Remove an event handler.
     *
     * @param events One or more space-separated event types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".
    ...
    */
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    resize(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "resize" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    resize(eventData: Object, handler: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    scroll(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "scroll" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    scroll(eventData: Object, handler: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    select(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "select" JavaScript event.
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    select(eventData: Object, handler: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute each time the event is triggered.
     */
    submit(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "submit" JavaScript event
     *
     * @param eventData An object containing data that will be passed to the event handler.
     * @param handler A function to execute each time the event is triggered.
     */
    submit(eventData?: any, handler?: JQueryEventListener): JQuery;
     ...
     * @param handler A function to execute when the event is triggered.
     */
    unload(handler: JQueryEventListener): JQuery;
    /**
     * Bind an event handler to the "unload" JavaScript event. (DEPRECATED from v1.8)
     *
     ...
     * @param handler A function to execute when the event is triggered.
     */
    unload(eventData?: any, handler?: JQueryEventListener): JQuery;
     ...
     */
    each(func: (this: HTMLElement, index: number, elem: Element) => any): JQuery;
